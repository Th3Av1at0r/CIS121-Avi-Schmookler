...
int main()
{
    ...
    cout << "\"Project_37-Lab_10\"\n\tObjectives: When a player gets 3 "
        << "horizontal, vertical or diagonal #’s in a row, then display "
        << "the game is overand that player wins AND which squares were "
        << "used in the win.If neither player wins, indicate the tie\n\n";
